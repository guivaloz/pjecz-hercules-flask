...
class PenExpedienteForm(FlaskForm):
    ...
    juez = SelectField("Juez", validators=[DataRequired()])
    secretario = SelectField("Secretario", validators=[DataRequired()])
    agente_mp = SelectField("Agente M.P.", validators=[DataRequired()])
