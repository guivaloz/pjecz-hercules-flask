...
class PenExpedienteForm(FlaskForm):
    ...
    juez = SelectField("Juez", choices=None, validators=[DataRequired()], validate_choice=False)
    secretario = SelectField("Secretario", choices=None, validators=[DataRequired()], validate_choice=False)
    agente_mp = SelectField("Agente M.P.", choices=None, validators=[DataRequired()], validate_choice=False)
